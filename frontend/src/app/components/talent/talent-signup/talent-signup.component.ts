...
@Component({
  ...
  styleUrls: ['./talent-signup.component.scss']
})
export class TalentSignupComponent implements OnInit {
  ...
  onSubmit() {
    ...
    // this.authService.talentRegister(email, password).subscribe((response) => {
